  ...
  return (
    <Card className={`fj-card ${mode}`}>
      <div className="card-body-wrapper">
        ...
        <div className="view overlay">{mode === "placeholder" ? <div className="image-placeholder" /> : <Card.Img src={urlFor(image).height(300).crop("center").fit("clip").url()} alt="Card image cap" />}</div>
        <Card.Body>
          {mode === "placeholder" ? (
            <>
            ...
            <>
              ...
              <Card.Text>{subtitle.length > 40 ? title.substr(0, 40) + "..." : subtitle}</Card.Text>
            </>
          )}
        </Card.Body>
      </div>
